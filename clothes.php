<html>
    <head>
        <title> ramoo</title>
        <meta charset="utf-8">
		<link rel="stylesheet" href="CSS/pejer.css" />
    </head>
     <body>
           <div class="oooo">
           <ul class="lll">
			  ...
			  >
               ...
               <div class="contanier">
				...
				<div class="gallery">                                               <!-- كود الصور كلنك مدمجه مع النص -->
				   ...
				   <div class="gallery">                                               <!-- كود الصور كلنك مدمجه مع النص -->
					  <img src="pog.jpg" alt=" موجوده الصورة غير" width="100" height="80">
					<div class="desc">poqma</div>
					<a id="asd" href="pay.php"> $230 </a>
				  </div>
				   <div class="gallery">                                               <!-- كود الصور كلنك مدمجه مع النص -->
					  <img src="IMG-20201130-WA0024.jpg" alt=" موجوده الصورة غير" width="100" height="80">
					<div class="desc">JHDF</div>
					<a id="asd" href="pay.php"> $3000 </a>
				  </div>
				   <div class="gallery">                                               <!-- كود الصور كلنك مدمجه مع النص -->
					  <img src="images.jpg"images alt=" موجوده الصورة غير" width="100" height="80">
